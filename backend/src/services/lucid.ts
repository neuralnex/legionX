...
// Load the contract address from me.addr
const contractAddress = readFileSync(join(__dirname, "me.addr"), "utf8").trim();

// Load the private key from me.sk
const privateKey = readFileSync(join(__dirname, "me.sk"), "utf8").trim();
...
const blockFrostProvider = () => new Blockfrost("https://cardano-preprod.blockfrost.io/api/v0", blockfrostApiKey as string);
...
export class LucidService {
        ...
        private async initializeLucid() {
                try {
                        // Initialize Lucid with Blockfrost provider
                        this.lucid = await Lucid(blockFrostProvider(), 'Preprod');
                ...
                const oracleValidator: Script = {
                        type: "PlutusV3",
                        script: ""
                };

                this.marketValidatorAddress = this.lucid.validatorToAddress(marketValidator);
                this.oracleValidatorAddress = this.lucid.validatorToAddress(oracleValidator);
        }
        ...
        async createListing(listing: Listing, seller: User): Promise<string> {
                try {
                        const tx = await this.lucid.newTx()
                                .pay.ToAddress(this.marketValidatorAddress, { lovelace: listing.price })
                                .attachMetadata(674, {
                                        listingId: listing.id,
                                        price: listing.price.toString(),
                                        full_price: listing.fullPrice?.toString() || null,
                                        seller: seller.wallet || '',
                                        action: 'List',
                                        modelMetadata: listing.modelMetadata,
        ...
        async cancelListing(listing: Listing, seller: User): Promise<string> {
                try {
                        const tx = await this.lucid.newTx()
                                .pay.ToAddress(this.marketValidatorAddress, { lovelace: 0n })
                                .attachMetadata(674, {
                                        listingId: listing.id,
                                        price: listing.price.toString(),
                                        full_price: listing.fullPrice?.toString() || null,
        ...
        async createPurchase(purchase: Purchase, buyer: User): Promise<string> {
                try {
                        const tx = await this.lucid.newTx()
                                .pay.ToAddress(this.marketValidatorAddress, { lovelace: purchase.amount })
                                .attachMetadata(674, {
                                        purchaseId: purchase.id,
                                        price: purchase.amount.toString(),
                                        buyer: buyer.wallet || '',
                                        action: 'Purchase',
                                        modelMetadata: purchase.listing.modelMetadata,
        ...
        async updatePurchase(purchase: Purchase, buyer: User): Promise<string> {
                try {
                        const tx = await this.lucid.newTx()
                                .pay.ToAddress(this.marketValidatorAddress, { lovelace: purchase.amount })
                                .attachMetadata(674, {
        ...
        async cancelPurchase(purchase: Purchase, buyer: User): Promise<string> {
                try {
                        const tx = await this.lucid.newTx()
                                .pay.ToAddress(this.marketValidatorAddress, { lovelace: 0n })
                                .attachMetadata(674, {
                        ...
                        this.logger.error('Error canceling purchase:', error);
