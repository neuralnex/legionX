...
const contractAddress = readFileSync(join(__dirname, "../../smartcontract/me.addr"), "utf8").trim();
...
async function initializeLucid() {
  const lucid = await Lucid.new(
    new Blockfrost("https://cardano-preprod.blockfrost.io/api/v0",blockfrostApiKey as string),
    "Preprod"
  );
