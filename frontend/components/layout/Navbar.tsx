      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <NavLink href="/creators" active={pathname === "/creators"}>
              Creators
            </NavLink>
...
const NavLink = ({ href, active, children }: NavLinkProps) => {
  return (
    <Link href={href} className="relative">
      <span className={`text-sm ${active ? "text-white font-medium" : "text-gray-300 hover:text-white"}`}>
        {children}
      </span>
      {active && (
        <motion.div
    ...
    <Link href={href} onClick={onClick}>
      <div
        className={`block px-3 py-2 rounded-md text-base font-medium ${
          active ? "text-white bg-purple-600" : "text-gray-300 hover:text-white hover:bg-gray-800"
        }`}
      >
        {children}
      </div>
